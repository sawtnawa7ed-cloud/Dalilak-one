...
export const evaluationsTable = pgTable("evaluations", {
  ...
  hasAccessibleParking: boolean("has_accessible_parking").notNull().default(false),
  hasSignLanguage: boolean("has_sign_language").default(false),
  hasBraille: boolean("has_braille").default(false),
  rampCondition: rampConditionEnum("ramp_condition"),
  notes: text("notes"),
