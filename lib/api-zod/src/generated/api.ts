...
export const ListPlacesResponseItem = zod.object({
  ...
  hasAccessibleParking: zod.boolean().optional(),
  createdAt: zod.string(),
});
      ...
      evaluations: zod
        .array(
          zod.object({
            ...
            hasAccessibleParking: zod.boolean(),
            hasSignLanguage: zod.boolean().optional(),
            hasBraille: zod.boolean().optional(),
            rampCondition: zod.string().optional(),
...
export const SubmitEvaluationBody = zod.object({
  ...
  hasSignLanguage: zod.boolean().optional(),
  hasBraille: zod.boolean().optional(),
  rampCondition: zod.enum(["good", "fair", "poor"]).optional(),
  notes: zod.string().optional(),
