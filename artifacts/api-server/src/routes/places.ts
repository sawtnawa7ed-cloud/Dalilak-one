...
router.get("/:id", async (req, res) => {
  ...
  const [place] = await db
    .select({
      ...
      hasAccessibleBathroom: placesTable.hasAccessibleBathroom, hasAccessibleParking: placesTable.hasAccessibleParking,
  ...
  const evaluations = await db.select({
    ...
    hasAccessibleBathroom: evaluationsTable.hasAccessibleBathroom, hasAccessibleParking: evaluationsTable.hasAccessibleParking,
    hasSignLanguage: evaluationsTable.hasSignLanguage, hasBraille: evaluationsTable.hasBraille,
    rampCondition: evaluationsTable.rampCondition, notes: evaluationsTable.notes,
...
router.post("/:id/evaluation", async (req, res) => {
  ...
  const [evaluation] = await db.insert(evaluationsTable).values({
    ...
    hasAccessibleParking: bodyParsed.data.hasAccessibleParking,
    hasSignLanguage: bodyParsed.data.hasSignLanguage ?? false,
    hasBraille: bodyParsed.data.hasBraille ?? false,
    rampCondition: bodyParsed.data.rampCondition ?? null,
